...
SELECT a.id, a.description, a.is_correct, a.file_id FROM question_answers JOIN answers a on question_answers.answer_id = a.id WHERE question_id=3 AND a.is_correct=1
  ...
  "questions": [
    {
      ...
      "title": "How many legs does the dog have ?"
    }
  ],
